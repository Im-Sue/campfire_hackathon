...
public interface ErrorCodeConstants {
    ...
    // ========== AI Agent 1-040-012-000 ==========
    ErrorCode AI_AGENT_NOT_EXISTS = new ErrorCode(1_040_012_000, "Agent不存在");
    ErrorCode AI_AGENT_DISABLED = new ErrorCode(1_040_012_001, "Agent已停用");
    ErrorCode AI_AGENT_BALANCE_NOT_ENOUGH = new ErrorCode(1_040_012_002, "Agent余额不足");
    ErrorCode AI_AGENT_COUNT_NOT_ENOUGH = new ErrorCode(1_040_012_003, "Agent数量不足，至少需要2个");

    // ========== AI 事件房间 1-040-013-000 ==========
    ErrorCode AI_EVENT_ROOM_NOT_EXISTS = new ErrorCode(1_040_013_000, "房间不存在");
    ErrorCode AI_EVENT_ROOM_ALREADY_EXISTS = new ErrorCode(1_040_013_001, "该事件已存在讨论房间");
    ErrorCode AI_EVENT_ROOM_STATUS_ERROR = new ErrorCode(1_040_013_002, "房间状态错误");
    ErrorCode AI_EVENT_NOT_EXISTS = new ErrorCode(1_040_013_003, "事件不存在");
    ErrorCode AI_EVENT_NOT_TRADING = new ErrorCode(1_040_013_004, "事件不在交易中");

    // ========== AI 对话配额 1-040-014-000 ==========
    ErrorCode AI_CHAT_QUOTA_EXCEEDED = new ErrorCode(1_040_014_000, "对话次数已用尽");

    // ========== AI 用户互动 1-040-015-000 ==========
    ErrorCode INTERACTION_COMMENT_TOO_LONG = new ErrorCode(1_040_015_000, "评论内容不能超过30字");
